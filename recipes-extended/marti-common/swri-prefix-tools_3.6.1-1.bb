...
# matches with: https://github.com/ros2-gbp/marti_common-release/archive/release/humble/swri_prefix_tools/3.6.1-1.tar.gz
...
SRCREV = "f39ac7ef37a60a4ec336bd33524908e65536a2ca"
S = "${WORKDIR}/git"
